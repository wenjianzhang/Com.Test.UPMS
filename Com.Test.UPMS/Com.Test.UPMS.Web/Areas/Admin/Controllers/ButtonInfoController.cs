    ...
    public class ButtonInfoController : Controller
    {
        ...
        public async Task<JsonResult> Post(ButtonInfo entity)
        {
            ...
            string insertSQL = @"INSERT INTO ButtonInfo (
                                 ...
                                 UpdateDate ,
                                 Updater ,
                                 IsDel ) VALUES (@ButtonName,@ButtonCode,@ButtonIcon,@ButtonDesc,@Sort,@CreateDate,@Creater,@UpdateDate,@Updater,0)";
            try
            {
                int i = await ButtonInfoRepository.CreateAsync(insertSQL, entity);
