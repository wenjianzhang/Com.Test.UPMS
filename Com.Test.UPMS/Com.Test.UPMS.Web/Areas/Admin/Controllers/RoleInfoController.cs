    ...
    public class RoleInfoController : Controller
    {
        ...
        public async Task<JsonResult> Post(RoleInfo entity)
        {
            ...
            string insertSQL = @"INSERT INTO RoleInfo (
                                ...
                                UpdateDate ,
                                Updater ,
                                IsDel ) VALUES (@RoleName,@RoleCode,@RoleDesc,@RoleIcon,@Sort,@CreateDate,@Creater,@UpdateDate,@Updater,0)";
            try
            {
                int i = await RoleInfoRepository.CreateAsync(insertSQL, entity);
